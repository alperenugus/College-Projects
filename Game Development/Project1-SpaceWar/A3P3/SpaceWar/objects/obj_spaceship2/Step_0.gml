...
if(keyboard_check(ord("W")) && fuel > 0){
	...
	// Thrust sprite
	sprite_index = s_spaceship2_flame
}
...
if(keyboard_check(ord("S"))){
	...
	if(global.MISSILE_INSTANCE_TIMER mod 20 == 0 && missile_num > 0){
		// Decrement missile_num
		missile_num -= 1
		
		missile_inst = instance_create_depth(x, y, 0, obj_missile2)
