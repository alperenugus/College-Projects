...
public class Party {
	...
	public Party() {
		...
		people.add(new Soldier("John" , "Infantry"));
		people.add(new Teacher("Frank" , "Professor"));
		people.add(new Liar("Abraham" , "Football Player" , "male"));
		people.add(new Soldier("Oliver" , "Artillary"));
		people.add(new Teacher("Harry" , "Professor"));
		people.add(new Liar("Michael" , "Student" , "female"));
		}
